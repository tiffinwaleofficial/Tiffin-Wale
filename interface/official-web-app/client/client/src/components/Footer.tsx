    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-4">TiffinWale</h3>
            <p className="text-gray-400 mb-4">
              Delicious, homestyle meals delivered fresh to your doorstep.
            </p>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/meal-plans">
                  <span className="text-gray-400 hover:text-white cursor-pointer">Meal Plans</span>
                </Link>
              </li>
              <li>
                <Link href="/corporate-plans">
                  <span className="text-gray-400 hover:text-white cursor-pointer">Corporate Plans</span>
                </Link>
              </li>
              <li>
                <Link href="/about">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Email: support@tiffinwale.com</li>
              <li>Phone: +91 98765 43210</li>
              <li>Address: 123 Food Street, Mumbai, India 400001</li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} TiffinWale. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
