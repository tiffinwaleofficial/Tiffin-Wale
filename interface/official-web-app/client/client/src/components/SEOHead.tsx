...
const SEOHead: React.FC<SEOProps> = ({
  title = 'TiffinWale - Home-Style Meal Subscription Service',
  description = 'TiffinWale delivers fresh, authentic home-style meals directly to your doorstep with flexible subscription plans. Enjoy daily homemade food without the hassle of cooking.',
  keywords = defaultKeywords,
  ogImage = '/logo.png',
  ogUrl = 'https://tiffin-wale.com',
  canonical = 'https://tiffin-wale.com',
  schema
}) => {
  ...
  return (
    <Helmet>
      ...
      {/* RSS Feed */}
      <link rel="alternate" type="application/rss+xml" title="TiffinWale RSS Feed" href="https://tiffin-wale.com/feed.xml" />
    </Helmet>
  );
};
