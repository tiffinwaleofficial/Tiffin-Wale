...
export class PaymentController {
  ...
  @ApiResponse({ status: 200, description: 'Returns all payment methods for the specified customer.' })
  ...
  @ApiResponse({ status: 200, description: 'The payment method has been set as default.' })
  @ApiResponse({ status: 404, description: 'Payment method not found.' })
