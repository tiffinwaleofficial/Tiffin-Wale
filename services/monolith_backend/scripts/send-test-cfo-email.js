...
const TEST_EMAIL = 'riyat4408@gmail.com';
...
async function sendTestEmail() {
  log('\n🚀 Sending CFO Welcome Email...', colors.magenta + colors.bright);
  
  try {
    // Correctly call the endpoint with /api prefix
    const response = await axios.post(`${BASE_URL}/api/email-test/send-cfo-welcome`, {
      to: TEST_EMAIL,
      name: TEST_NAME,
    }, {
